      ...
      <div class="color-theme-blue mont-font">
        ...
        <div class="main-wrapper">
                ...
                <div class="middle-wrap">
                  <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                    <div class="card-body p-lg-5 p-4 w-100 border-0">
                      <div class="row">
                        <div class="col-lg-12">
                          <h4 class="mb-4 font-xxl fw-700 mont-font mb-lg-5 mb-4 font-md-xs">
                            Settings
                          </h4>
                          ...
                          <ul class="list-inline mb-4">
                            <li class="list-inline-item d-block border-bottom me-0">
                              ...
                              >
                                <i class="btn-round-md bg-primary-gradiant text-white feather-home font-md me-3"></i>
                            ...
                            <li class="list-inline-item d-block border-bottom me-0">
                              <a
                                ...
                                class="pt-2 pb-2 d-flex align-items-center"
                              >
                                <i class="btn-round-md bg-gold-gradiant text-white feather-map-pin font-md me-3"></i>
                                <h4 class="fw-600 font-xsss mb-0 mt-0">
                                  Saved Address
                                </h4>
                                <i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                            ...
                            <li class="list-inline-item d-block me-0">
                              <a
                                ...
                                class="pt-2 pb-2 d-flex align-items-center"
                              >
                                <i class="btn-round-md bg-red-gradiant text-white feather-twitter font-md me-3"></i>
                                <h4 class="fw-600 font-xsss mb-0 mt-0">
                                  Social Acount
                                </h4>
                                <i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                          ...
                          <ul class="list-inline mb-4">
                            <li class="list-inline-item d-block border-bottom me-0">
                              <a
                                ...
                                class="pt-2 pb-2 d-flex align-items-center"
                              >
                                <i class="btn-round-md bg-mini-gradiant text-white feather-credit-card font-md me-3"></i>
                                <h4 class="fw-600 font-xsss mb-0 mt-0">
                                  My Cards
                                </h4>
                                <i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                            ...
                            <li class="list-inline-item d-block  me-0">
                              <a
                                ...
                                class="pt-2 pb-2 d-flex align-items-center"
                              >
                                <i class="btn-round-md bg-blue-gradiant text-white feather-inbox font-md me-3"></i>
                                <h4 class="fw-600 font-xsss mb-0 mt-0">
                                  Password
                                </h4>
                                <i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                          ...
                          <ul class="list-inline">
                            <li class="list-inline-item d-block border-bottom me-0">
                              <a
                                ...
                                class="pt-2 pb-2 d-flex align-items-center"
                              >
                                <i class="btn-round-md bg-gold-gradiant text-white feather-bell font-md me-3"></i>
                                <h4 class="fw-600 font-xsss mb-0 mt-0">
                                  Notification
                                </h4>
                                <i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                            ...
                            <li class="list-inline-item d-block border-bottom me-0">
                              ...
                              >
                                ...
                                <h4 class="fw-600 font-xsss mb-0 mt-0">Help</h4>
                                <i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                              </a>
                            </li>
                            <li class="list-inline-item d-block me-0">
            ...
            <div class="middle-sidebar-right-content bg-white shadow-xss rounded-xxl">
              ...
              <div class="section full pe-3 ps-4 pt-4 position-relative feed-body">
                ...
                <ul class="list-group list-group-flush">
                  <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                    ...
                    <span class="badge badge-primary text-white badge-pill fw-500 mt-0">
                      2
                    </span>
                  </li>
                  <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                  ...
                  <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                    ...
                    <span class="badge mt-0 text-grey-500 badge-pill pe-0 font-xsssss">
                      4:09 pm
                    </span>
                  </li>
                  <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              ...
              <div class="section full pe-3 ps-4 pt-4 pb-4 position-relative feed-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                    <span class="btn-round-sm bg-mini-gradiant me-3 ls-3 text-white font-xssss fw-700">
                      UD
                    </span>
                    <h3 class="fw-700 mb-0 mt-0">
                      <a
          ...
          <div class="app-footer border-0 shadow-lg bg-primary-gradiant">
            ...
            <Link to="/setting" class="nav-content-bttn">
              <img
