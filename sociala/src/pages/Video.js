                             ...
                             <div className="card w-100 border-0 shadow-xss rounded-xxl border-0 p-4 mb-3 overflow-hidden">
                                ...
                                <div className="card-body p-0 d-block mb-4">
                                    <div className="owl-carousel owl-theme category-card overflow-visible owl-dot-nav nav-none style2 chatlist">
                                        ...
                                        <div className="item online">
                                            <div className="card bg-transparent bg-transparent-card border-0 shadow-none">
                                                <div className="card-image text-center"><a href="#" data-target="#Modalstries" data-toggle="modal"><img src="/assets/images/user-24.png" alt="image" className="d-inline p-0" /> <span className="d-block fw-600 font-xssss text-grey-600 text-dark">Anton</span></a></div>
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="card bg-transparent bg-transparent-card border-0 shadow-none">
                                                <div className="card-image text-center"><a href="#" data-target="#Modalstries" data-toggle="modal"><img src="/assets/images/user-21.png" alt="image" className="d-inline p-0" /> <span className="d-block fw-600 font-xssss text-grey-600 text-dark">Jane</span></a></div>
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="card bg-transparent bg-transparent-card border-0 shadow-none">
                                                <div className="card-image text-center"><a href="#" data-target="#Modalstries" data-toggle="modal"><img src="/assets/images/user-25.png" alt="image" className="d-inline p-0" /> <span className="d-block fw-600 font-xssss text-grey-600 text-dark">Wade</span></a></div>
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="card bg-transparent bg-transparent-card border-0 shadow-none">
                                                <div className="card-image text-center"><a href="#" data-target="#Modalstries" data-toggle="modal"><img src="/assets/images/user-12.png" alt="image" className="d-inline shadow p-0" /> <span className="d-block fw-600 font-xssss text-grey-600 text-dark">Cabe</span></a></div>
                                            </div>
                                        </div>
