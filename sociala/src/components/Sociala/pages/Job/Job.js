                    ...
                    <div className="row">
                        <div className="col-xl-6 chat-left scroll-bar">
                            <div className="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                                <div className="card-body d-flex align-items-center p-0">
                                    <h2 className="fw-700 mb-0 mt-0 font-md text-grey-900">Job</h2>
                            ...
                            <div className="card d-block w-100 border-0 mb-3 shadow-xss bg-white rounded-3 p-4" style={{paddingLeft: '120px !important'}}>
                            <div className='row'>
                                <div className='col-md-2'>
                                <img src="/assets/images/download7.png" alt="images" className="position-absolute p-2 bg-lightblue2 w65 ms-4 left-0" />
                                </div>
                                <div className='col-md-10'>
                                <i className="feather-bookmark font-md text-grey-500 position-absolute right-0 me-3"></i>
                                <h4 className="font-xss fw-700 text-grey-900 mb-3 pe-4">Python Developer <span className="font-xssss fw-500 text-grey-500 ms-4">(3 days ago)</span> </h4>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Location : </span> London, United Kingdom</h5>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Employment : </span> Part Time</h5>
                                <h5 className="font-xssss text-grey-500 fw-600 mb-3"><span className="text-grey-900 font-xssss">Salary : </span> 12000 -45000</h5>
                                ...
                                <a href="#" className="position-absolute bottom-15 mb-3 right-15"><i className="btn-round-sm bg-primary-gradiant text-white font-sm feather-chevron-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div className='row'>
                                <div className='col-md-2'>
                                <img src="/assets/images/download4.png" alt="images" className="position-absolute p-2 bg-lightblue2 w65 ms-4 left-0" />
                                </div>
                                <div className='col-md-10'>
                                <i className="feather-bookmark font-md text-danger position-absolute right-0 me-3"></i>
                                <h4 className="font-xss fw-700 text-grey-900 mb-3 pe-4">Sass Developer <span className="font-xssss fw-500 text-grey-500 ms-4">(3 days ago)</span> </h4>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Location : </span> London, United Kingdom</h5>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Employment : </span> Part Time</h5>
                                <h5 className="font-xssss text-grey-500 fw-600 mb-3"><span className="text-grey-900 font-xssss">Salary : </span> 12000 -45000</h5>
                                <h6 className="d-inline-block p-2 text-success alert-success fw-600 font-xssss rounded-3 me-2">UX Design</h6>
                            ...
                            <div className='row'>
                                <div className='col-md-2'>
                                <img src="/assets/images/download6.png" alt="images" className="position-absolute p-2 bg-lightblue2 w65 ms-4 left-0" />
                                </div>
                                <div className='col-md-10'>
                                <i className="feather-bookmark font-md text-danger position-absolute right-0 me-3"></i>
                                <h4 className="font-xss fw-700 text-grey-900 mb-3 pe-4">Java Developer <span className="font-xssss fw-500 text-grey-500 ms-4">(3 days ago)</span> </h4>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Location : </span> London, United Kingdom</h5>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Employment : </span> Part Time</h5>
                                <h5 className="font-xssss text-grey-500 fw-600 mb-3"><span className="text-grey-900 font-xssss">Salary : </span> 12000 -45000</h5>
                                <h6 className="d-inline-block p-2 text-success alert-success fw-600 font-xssss rounded-3 me-2">UX Design</h6>
                            ...
                            <div className='row'>
                                <div className='col-md-2'>
                                <img src="/assets/images/download5.png" alt="images" className="position-absolute p-2 bg-lightblue2 w65 ms-4 left-0" />
                                </div>
                                <div className='col-md-10'>
                                <i className="feather-bookmark font-md text-grey-500 position-absolute right-0 me-3"></i>
                                <h4 className="font-xss fw-700 text-grey-900 mb-3 pe-4">React Developer <span className="font-xssss fw-500 text-grey-500 ms-4">(3 days ago)</span> </h4>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Location : </span> London, United Kingdom</h5>
                                <h5 className="font-xssss mb-2 text-grey-500 fw-600"><span className="text-grey-900 font-xssss">Employment : </span> Part Time</h5>
                                <h5 className="font-xssss text-grey-500 fw-600 mb-3"><span className="text-grey-900 font-xssss">Salary : </span> 12000 -45000</h5>
                                <h6 className="d-inline-block p-2 text-success alert-success fw-600 font-xssss rounded-3 me-2">UX Design</h6>
                        ...
                        <div className="col-xl-6 ps-0 d-none d-xl-block">
                            <div className="card w-100 border-0 shadow-none rounded-3 border-0 mb-4 overflow-hidden ">
                                <div id="map" className="rounded-3" style={{height: '86vh'}}></div>
