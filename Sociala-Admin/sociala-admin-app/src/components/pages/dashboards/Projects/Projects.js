                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="avatar-sm flex-shrink-0">
                                                    <span className="avatar-title bg-soft-primary text-primary rounded-2 fs-2">
                                                        <i data-feather="briefcase" className="text-primary"></i>
                                                    </span>
                                                </div>
                                                <div className="flex-grow-1 overflow-hidden ms-3">
                                                    <p className="text-uppercase fw-medium text-muted text-truncate mb-3">Active Projects</p>
                                                    <div className="d-flex align-items-center mb-3">
                                                        <h4 className="fs-4 flex-grow-1 mb-0"><span className="counter-value" data-target="825">0</span></h4>
                                ...
                                <div className="col-xl-12">
                                    <div className="card">
                                        ...
                                        <div className="card-body p-0 pb-2">
                                            <div>
                                                <div id="projects-overview-chart" data-colors='["--vz-primary", "--vz-warning", "--vz-success"]' className="apex-charts" dir="ltr"></div>
                                            </div>
                                        </div>
                                        {/* <!-- end card body --> */}
                                    </div>
                        ...
                        <div className="col-xl-5">
                            <div className="card card-height-100">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mt-3 text-center">
                                        <a href="javascript:void(0);" className="text-muted text-decoration-underline">Load More</a>
                                    </div>
                                </div>
                                {/* <!-- end cardbody --> */}
                            </div>
                    ...
                    <div className="row">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="fs-13 mb-0 text-muted">Product Manager</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h6 className="mb-0">110h : <span className="text-muted">150h</span></h6>
                                                    </td>
                                                    <td>
                                                        258
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0">Jansh Brown</h6>
                                                            <p className="fs-13 mb-0 text-muted">Lead Developer</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h6 className="mb-0">83h : <span className="text-muted">150h</span></h6>
                                                    </td>
                                                    <td>
                                                        105
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0">Carroll Adams</h6>
                                                            <p className="fs-13 mb-0 text-muted">Lead Designer</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h6 className="mb-0">58h : <span className="text-muted">150h</span></h6>
                                                    </td>
                                                    <td>
                                                        75
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0">William Pinto</h6>
                                                            <p className="fs-13 mb-0 text-muted">UI/UX Designer</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h6 className="mb-0">96h : <span className="text-muted">150h</span></h6>
                                                    </td>
                                                    <td>
                                                        85
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0">Garry Fournier</h6>
                                                            <p className="fs-13 mb-0 text-muted">Web Designer</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0">Susan Denton</h6>
                                                            <p className="fs-13 mb-0 text-muted">Lead Designer</p>
                                                        </div>
                                                    </td>

                                                    <td>
                                                        <h6 className="mb-0">123h : <span className="text-muted">150h</span></h6>
                                                    </td>
                                                    <td>
                                                        658
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0">Joseph Jackson</h6>
                                                            <p className="fs-13 mb-0 text-muted">React Developer</p>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h6 className="mb-0">117h : <span className="text-muted">150h</span></h6>
                                                    </td>
                                                    <td>
                                                        125
                                                    </td>
                        ...
                        <div className="col-xxl-4 col-lg-6">
                            <div className="card card-height-100">
                                ...
                                <div className="card-body">
                                    <div id="prjects-status" data-colors='["--vz-success", "--vz-primary", "--vz-warning", "--vz-danger"]' className="apex-charts" dir="ltr"></div>
                                    <div className="mt-3">
