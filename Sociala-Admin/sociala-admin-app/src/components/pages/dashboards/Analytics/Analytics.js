                                                ...
                                                <div className="row align-items-end">
                                                    <div className="col-sm-8">
                                                        <div className="p-3">
                                                            ...
                                                            <div className="mt-3">
                                                                <a href="pages-pricing.html" className="btn btn-secondary">Upgrade Account!</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <div className="avatar-sm flex-shrink-0">
                                                            <span className="avatar-title bg-soft-info rounded-circle fs-2">
                                                                <i data-feather="users" className="text-info"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <div className="avatar-sm flex-shrink-0">
                                                            <span className="avatar-title bg-soft-info rounded-circle fs-2">
                                                                <i data-feather="activity" className="text-info"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <div className="avatar-sm flex-shrink-0">
                                                            <span className="avatar-title bg-soft-info rounded-circle fs-2">
                                                                <i data-feather="external-link" className="text-info"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div className="row h-100">
                                <div className="col-xl-6">
                                    <div className="card card-height-100">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div id="users-by-country" data-colors='["--vz-light"]' className="text-center" style={{height: '252px'}}></div>
                                ...
                                <div className="col-xl-6">
                                    <div className="card card-height-100">
                                        ...
                                        <div className="card-body p-0">
                                            <div>
                                                <div id="countries_charts" data-colors='["--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-danger", "--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-info"]' className="apex-charts" dir="ltr"></div>
                                            </div>
                                        </div>
                                        {/* <!-- end card body --> */}
                                    </div>
                    ...
                    <div className="row">
                        <div className="col-xl-6">
                            <div className="card">
                                ...
                                <div className="card-body p-0 pb-2">
                                    <div>
                                        <div id="audiences_metrics_charts" data-colors='["--vz-primary", "--vz-gray-300"]' className="apex-charts" dir="ltr"></div>
                                    </div>
                                </div>
                                {/* <!-- end card body --> */}
                            </div>
                        ...
                        <div className="col-xl-6">
                            <div className="card card-height-100">
                                ...
                                <div className="card-body p-0">
                                    <div>
                                        <div id="audiences-sessions-country-charts" data-colors='["--vz-success", "--vz-secondary"]' className="apex-charts" dir="ltr"></div>
                                    </div>
                                </div>
                                {/* <!-- end cardbody --> */}
                            </div>
                    ...
                    <div className="row">
                        <div className="col-xl-4">
                            <div className="card card-height-100">
                                ...
                                {/* <!-- end card header --> */}
                                <div className="card-body">
                                    <div id="user_device_pie_charts" data-colors='["--vz-primary", "--vz-warning", "--vz-info"]' className="apex-charts" dir="ltr"></div>
                                            ...
                                            <tbody className="border-0">
                                                <tr>
                                                    ...
                                                    <td className="text-end">
                                                        <p className="text-success fw-medium fs-13 mb-0"><i className="ri-arrow-up-s-fill fs-5 align-middle"></i>2.08%
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h4 className="text-truncate fs-14 fs-medium mb-0"><i className="ri-stop-fill align-middle fs-18 text-warning me-2"></i>Mobile
                                                            Users</h4>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td className="text-end">
                                                        <p className="text-danger fw-medium fs-13 mb-0"><i className="ri-arrow-down-s-fill fs-5 align-middle"></i>10.52%
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h4 className="text-truncate fs-14 fs-medium mb-0"><i className="ri-stop-fill align-middle fs-18 text-info me-2"></i>Tablet
                                                            Users</h4>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td className="text-end">
                                                        <p className="text-danger fw-medium fs-13 mb-0"><i className="ri-arrow-down-s-fill fs-5 align-middle"></i>7.36%
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div className="mt-3 pt-2">
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="text-truncate text-muted fs-15 mb-0"><i className="mdi mdi-circle align-middle text-primary me-2"></i>www.google.com
                                                </p>
                                            </div>
                                            <div className="flex-shrink-0">
                                        ...
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="text-truncate text-muted fs-15 mb-0"><i className="mdi mdi-circle align-middle text-info me-2"></i>www.youtube.com
                                                </p>
                                            </div>
                                            <div className="flex-shrink-0">
                                        ...
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="text-truncate text-muted fs-15 mb-0"><i className="mdi mdi-circle align-middle text-success me-2"></i>www.meta.com
                                                </p>
                                            </div>
                                            <div className="flex-shrink-0">
                                        ...
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="text-truncate text-muted fs-15 mb-0"><i className="mdi mdi-circle align-middle text-warning me-2"></i>www.medium.com
                                                </p>
                                            </div>
                                            <div className="flex-shrink-0">
                                        ...
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="text-truncate text-muted fs-15 mb-0"><i className="mdi mdi-circle align-middle text-danger me-2"></i>Other
                                                </p>
                                            </div>
                                            <div className="flex-shrink-0">
