                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Crypto</h4>
                        ...
                        <div className="col-xxl-3">
                            <div className="card card-height-100">
                                <div className="card-header border-0 align-items-center d-flex">
                                    ...
                                    <div>
                                        <div className="dropdown">
                                            <button className="btn btn-soft-primary btn-sm" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div className="card-body">
                                    <div id="portfolio_donut_charts" data-colors='["--vz-primary", "--vz-info", "--vz-warning", "--vz-success"]' className="apex-charts" dir="ltr"></div>
                                        ...
                                        <li className="list-group-item px-0">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    <p className="fs-13 mb-0 text-muted"><i className="mdi mdi-circle fs-10 align-middle text-primary me-1"></i>BTC
                                                    </p>
                                                </div>
                                        ...
                                        <li className="list-group-item px-0">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    <p className="fs-13 mb-0 text-muted"><i className="mdi mdi-circle fs-10 align-middle text-info me-1"></i>ETH
                                                    </p>
                                                </div>
                                                <div className="flex-shrink-0 text-end">
                                        ...
                                        <li className="list-group-item px-0">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    <p className="fs-13 mb-0 text-muted"><i className="mdi mdi-circle fs-10 align-middle text-warning me-1"></i>LTC
                                                    </p>
                                                </div>
                                                <div className="flex-shrink-0 text-end">
                                        ...
                                        <li className="list-group-item px-0 pb-0">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    <p className="fs-13 mb-0 text-muted"><i className="mdi mdi-circle fs-10 align-middle text-success me-1"></i>DASH
                                                    </p>
                                                </div>
                                                <div className="flex-shrink-0 text-end">
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <p className="text-uppercase fw-semibold fs-13 text-muted mb-1">
                                                            Total Invested</p>
                                                        <h4 className=" mb-0">$<span className="counter-value" data-target="2390.68">0</span></h4>
                                                    </div>
                                                    <div className="flex-shrink-0 align-self-end">
                                                        <span className="badge badge-soft-success"><i className="ri-arrow-up-s-fill align-middle me-1"></i>6.24
                                                            %<span>
                                                            </span></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="card-body">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <p className="text-uppercase fw-semibold fs-13 text-muted mb-1">
                                                            Total Change</p>
                                                        <h4 className=" mb-0">$<span className="counter-value" data-target="19523.25">0</span></h4>
                                                    </div>
                                                    <div className="flex-shrink-0 align-self-end">
                                                        <span className="badge badge-soft-success"><i className="ri-arrow-up-s-fill align-middle me-1"></i>3.67
                                                            %<span>
                                                            </span></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="card">
                                            <div className="card-body">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <p className="text-uppercase fw-semibold fs-13 text-muted mb-1">Day
                                                            Change</p>
                                                        <h4 className=" mb-0">$<span className="counter-value" data-target="14799.44">0</span></h4>
                                                    </div>
                                                    <div className="flex-shrink-0 align-self-end">
                                                        <span className="badge badge-soft-danger"><i className="ri-arrow-down-s-fill align-middle me-1"></i>4.80
                                                            %<span>
                                                            </span></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-xl-12">
                                        <div className="card">
                                                    ...
                                                    <div className="row align-items-center">
                                                        <div className="col-6">
                                                            <div className="d-flex flex-wrap gap-4 align-items-center">
                                                                ...
                                                                <p className="fw-medium text-muted mb-0">$75.69 <span className="text-success fs-13 ms-1">+1.99%</span>
                                                                </p>
                                                                <p className="fw-medium text-muted mb-0">High <span className="text-dark fs-13 ms-1">0.014578</span></p>
                                                                <p className="fw-medium text-muted mb-0">Low <span className="text-dark fs-13 ms-1">0.0175489</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        {/* <!-- end col --> */}
                                                        <div className="col-6">
                                                            <div className="d-flex">
                                                                <div className="d-flex justify-content-end text-end flex-wrap gap-4 ms-auto">
                                                                    <div className="pe-3">
                                                                        <h6 className="mb-2 text-truncate text-muted">Total
                                                                            Balance</h6>
                                            ...
                                            <div className="card-body p-0 pb-3">
                                                <div id="Market_chart" data-colors='["--vz-success", "--vz-danger"]' className="apex-charts" dir="ltr">
                                                </div>
                                            </div>
                                            {/* <!-- end cardbody --> */}
                                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="swiper cryptoSlider">
                                        ...
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$1,523,647</h5>
                                                        <p className="text-success fw-medium mb-0">+13.11%<span className="text-muted ms-2 text-uppercase">(btc)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-success" , "--vz-transparent"]' id="bitcoin_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$2,145,687</h5>
                                                        <p className="text-success fw-medium mb-0">+15.08%<span className="text-muted ms-2 text-uppercase">(ltc)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' id="litecoin_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$3,312,870</h5>
                                                        <p className="text-success fw-medium mb-0">+08.57%<span className="text-muted ms-2 text-uppercase">(etc)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' id="eathereum_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$1,820,045</h5>
                                                        <p className="text-danger fs-13 fw-medium mb-0">-09.21%<span className="text-muted ms-2 text-uppercase">(bnb)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-danger", "--vz-transparent"]' id="binance_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$9,458,153</h5>
                                                        <p className="text-success fw-medium mb-0">+12.07%<span className="text-muted ms-2 text-uppercase">(dash)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' id="dash_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$5,201,458</h5>
                                                        <p className="text-success fw-medium mb-0">+14.99%<span className="text-muted ms-2 text-uppercase">(usdt)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' id="tether_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="row align-items-end g-0">
                                                    <div className="col-6">
                                                        <h5 className="mb-1 mt-4">$6,147,957</h5>
                                                        <p className="text-danger fs-13 fw-medium mb-0">-05.07%<span className="text-muted ms-2 text-uppercase">(neo)</span></p>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                    <div className="col-6">
                                                        <div className="apex-charts crypto-widget" data-colors='["--vz-danger", "--vz-transparent"]' id="neo_sparkline_charts" dir="ltr"></div>
                                                    </div>
                                                    {/* <!-- end col --> */}
                                                </div>
                                                {/* <!-- end row --> */}
                                ...
                                <div className="card-header align-items-center d-flex">
                                    ...
                                    <div className="flex-shrink-0 ms-2">
                                        <div className="dropdown card-header-dropdown">
                                            <a className="btn btn-soft-primary btn-sm" role="button" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <table className="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$48,568.025</td>
                                                    <td>
                                                        <h6 className="text-success mb-0"><i className="mdi mdi-trending-up align-middle me-1"></i>5.26
                                                        </h6>
                                                    </td>
                                                    <td>$53,914.025</td>
                                                    <td>1.25634801</td>
                                                    <td><a href="apps-crypto-buy-sell.html" className="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                </tr>
                                                {/* <!-- end --> */}
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>$87,142.027</td>
                                                    <td>
                                                        <h6 className="text-danger mb-0"><i className="mdi mdi-trending-down align-middle me-1"></i>3.07
                                                        </h6>
                                                    </td>
                                                    <td>$75,854.127</td>
                                                    <td>2.85472161</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$33,847.961</td>
                                                    <td>
                                                        <h6 className="text-success mb-0"><i className="mdi mdi-trending-up align-middle me-1"></i>7.13
                                                        </h6>
                                                    </td>
                                                    <td>$44,152.185</td>
                                                    <td>1.45612347</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$73,654.421</td>
                                                    <td>
                                                        <h6 className="text-success mb-0"><i className="mdi mdi-trending-up align-middle me-1"></i>0.97
                                                        </h6>
                                                    </td>
                                                    <td>$48,367.125</td>
                                                    <td>0.35734601</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$66,742.077</td>
                                                    <td>
                                                        <h6 className="text-danger mb-0"><i className="mdi mdi-trending-down align-middle me-1"></i>1.08
                                                        </h6>
                                                    </td>
                                                    <td>$53,487.083</td>
                                                    <td>3.62912570</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$34,736.209</td>
                                                    <td>
                                                        <h6 className="text-success mb-0"><i className="mdi mdi-trending-up align-middle me-1"></i>4.52
                                                        </h6>
                                                    </td>
                                                    <td>$15,203.347</td>
                                                    <td>1.85412740</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$56,357.313</td>
                                                    <td>
                                                        <h6 className="text-danger mb-0"><i className="mdi mdi-trending-down align-middle me-1"></i>2.87
                                                        </h6>
                                                    </td>
                                                    <td>$61,843.173</td>
                                                    <td>1.87732061</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$62,357.649</td>
                                                    <td>
                                                        <h6 className="text-success mb-0"><i className="mdi mdi-trending-up align-middle me-1"></i>3.45
                                                        </h6>
                                                    </td>
                                                    <td>$54,843.173</td>
                                                    <td>0.95632087</td>
                                    ...
                                    <div className="flex-shrink-0">
                                        <ul className="nav justify-content-end nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                            <li className="nav-item">
                                                <a className="nav-link active" data-bs-toggle="tab" href="#buy-tab" role="tab" aria-selected="false">Buy</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="nav-link" data-bs-toggle="tab" href="#sell-tab" role="tab" aria-selected="true">Sell</a>
                                            </li>
                                        </ul>
                                        {/* <!-- end ul --> */}
                                    </div>
                                    ...
                                    <div className="tab-content p-0">
                                        <div className="tab-pane active" id="buy-tab" role="tabpanel">
                                            ...
                                            <div className="p-3">
                                                ...
                                                <div className="mt-3 pt-2">
                                                    <button type="button" className="btn btn-primary w-100">Buy
                                                        Coin</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="tab-pane" id="sell-tab" role="tabpanel">
                                            ...
                                            <div className="p-3">
                                                ...
                                                <div className="mt-3 pt-2">
                                                    <button type="button" className="btn btn-danger w-100">Sell
                                                        Coin</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div data-simplebar style={{height: '390px'}}>
                                        <div className="p-3">
                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="avatar-xs flex-shrink-0">
                                                    <span className="avatar-title bg-light rounded-circle">
                                                        <i data-feather="arrow-down-circle" className="icon-dual-success icon-sm"></i>
                                                    </span>
                                                </div>
                                                <div className="flex-grow-1 ms-3">
                                            ...
                                            <div className="d-flex align-items-center mt-3">
                                                <div className="avatar-xs flex-shrink-0">
                                                    <span className="avatar-title bg-light rounded-circle">
                                                        <i data-feather="send" className="icon-dual-warning icon-sm"></i>
                                                    </span>
                                                </div>
                                                <div className="flex-grow-1 ms-3">
                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="avatar-xs flex-shrink-0">
                                                    <span className="avatar-title bg-light rounded-circle">
                                                        <i data-feather="arrow-up-circle" className="icon-dual-danger icon-sm"></i>
                                                    </span>
                                                </div>
                                                <div className="flex-grow-1 ms-3">
                                            ...
                                            <div className="d-flex align-items-center mt-3">
                                                <div className="avatar-xs flex-shrink-0">
                                                    <span className="avatar-title bg-light rounded-circle">
                                                        <i data-feather="arrow-up-circle" className="icon-dual-success icon-sm"></i>
                                                    </span>
                                                </div>
                                                <div className="flex-grow-1 ms-3">
                                ...
                                <div className="card-body p-0">
                                    <ul className="list-group list-group-flush border-dashed mb-0">
                                        <li className="list-group-item d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <h6 className="mb-1">Bitcoin</h6>
                                                <p className="text-muted mb-0">$18.7 Billions</p>
                                            </div>
                                            <div className="flex-shrink-0 text-end">
                                                <h6 className="mb-1">$12,863.08</h6>
                                                <p className="text-success fs-13 mb-0">+$67.21 (+4.33%)</p>
                                            </div>
                                        </li>
                                        {/* <!-- end --> */}
                                        <li className="list-group-item d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <p className="text-muted mb-0">$27.4 Billions</p>
                                            </div>
                                            <div className="flex-shrink-0 text-end">
                                                <h6 className="mb-1">$08,256.04</h6>
                                                <p className="text-success fs-13 mb-0">+$51.19<span className="ms-1">(+5.64%)</span></p>
                                            </div>
                                        </li>
                                        {/* <!-- end --> */}
                                        <li className="list-group-item d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <p className="text-muted mb-0">$12.9 Billions</p>
                                            </div>
                                            <div className="flex-shrink-0 text-end">
                                                <h6 className="mb-1">$11,896.13</h6>
                                                <p className="text-danger fs-13 mb-0">-$59.01<span className="ms-1">(-4.08%)</span></p>
                                            </div>
                                        </li>
                                        {/* <!-- end --> */}
                                        <li className="list-group-item d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <p className="text-muted mb-0">$09.5 Billions</p>
                                            </div>
                                            <div className="flex-shrink-0 text-end">
                                                <h6 className="mb-1">$15,999.06</h6>
                                                <p className="text-success fs-13 mb-0">+$74.05<span className="ms-1">(+3.12%)</span></p>
                                            </div>
                                        </li>
                                        {/* <!-- end --> */}
                                        <li className="list-group-item d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <p className="text-muted mb-0">$14.2 Billions</p>
                                            </div>
                                            <div className="flex-shrink-0 text-end">
                                                <h6 className="mb-1">$13,786.18</h6>
                                                <p className="text-danger fs-13 mb-0">-$61.05<span className="ms-1">(-9.22%)</span></p>
                                            </div>
                                        </li>
                                        {/* <!-- end --> */}
                                        <li className="list-group-item d-flex align-items-center">
                                            ...
                                            <div className="flex-shrink-0 text-end">
                                                <h6 className="mb-1">$10,604.27</h6>
                                                <p className="text-success fs-13 mb-0">+$76.12<span className="ms-1">(+4.92%)</span></p>
                                            </div>
                                        </li>
                                        {/* <!-- end --> */}
                                    </ul>
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-middle">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted fs-13 mb-0">Dec 12, 2021 <i className="mdi mdi-circle-medium align-middle mx-1"></i>09:22 AM</p>
                                        </div>
                                    </div>
                                    {/* <!-- end --> */}
                                    <div className="d-flex mt-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted fs-13 mb-0">Dec 03, 2021 <i className="mdi mdi-circle-medium align-middle mx-1"></i>12:09 PM</p>
                                        </div>
                                    </div>
                                    {/* <!-- end --> */}
                                    <div className="d-flex mt-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted fs-13 mb-0">Nov 22, 2021 <i className="mdi mdi-circle-medium align-middle mx-1"></i>11:47 AM</p>
                                        </div>
                                    </div>
                                    {/* <!-- end --> */}
                                    <div className="d-flex mt-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted fs-13 mb-0">Nov 18, 2021 <i className="mdi mdi-circle-medium align-middle mx-1"></i>06:13 PM</p>
                                        </div>
                                    </div>
                                    {/* <!-- end --> */}

                                    <div className="mt-3 text-center">
                                        <a href="#" className="text-muted text-decoration-underline">View
                                            all News</a>
                                    </div>
